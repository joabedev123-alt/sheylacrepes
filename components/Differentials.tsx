...
function DifferentialCard({ item, index }: { item: typeof differentials[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      style={{ background: 'rgba(21,21,46,0.5)', border: '1px solid rgba(139,92,246,0.15)' }}
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-lime mb-4 block">
